<html>
    ...
    <body>
        <div class="month">
            <ul>
                <li><input type="button" id="next" value=&#10095; onclick="monthUp()"></input></li>
                <li><input type="button" id="back" value=&#10094; onclick="monthDown()"></input></li>
                <li id="month"></li>
                <li id="year"></li>
            </ul>
        </div>
        ...
        <script type="text/javascript" src="/javascripts/calendarFunctions.js"></script>
    </body>
</html>